document.getElementById("cash-out").addEventListener("click", function (event) {
    ...
    const amount = getInputValueById("amount2");
    const pin = getInputValueById("pin2");
    ...
    const selectedBank = document.getElementById("allBank2").value;
                ...
                if (!isNaN(pin)) {
                    ...
                    div.innerHTML = `
                        <div class="flex gap-6">
                            ...
                            <div>
                               <h3 class="font-semibold">Cash Out</h3>
